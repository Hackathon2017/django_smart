...
from smartsearch.views import *
from smartsearch.feed import LatestPosts
...
urlpatterns = [
   ...
   # url(r'^specialists/(?P<pk>[0-9]+)/', SpecialistDetail.as_view()),	
    url(r'^smartsearch/(?P<slug>[\w\-]+)/$', DetailPostView.as_view(), name='detail_post_page'),
    ...
    url(r'^sitemap\.xml$', sitemap, {'sitemaps': {'smartsearch': GenericSitemap(
