...
class Command(BaseCommand):
    help = 'To backup the smartsearch using django-import-export!'
    ...
    def handle(self, *args, **options):
        if options['backup'] == 'yes':
            ...
            self.stdout.write(
                self.style.WARNING('[-] Can not backup smartsearch!')
            )
